...
public final class WebappPaths {
	 ...
	 * 1.7.3. CONFIRMATION
	 */
	public static final String HARVESTING_LIMESURVEY_QUESTION_LINK_CONFIRMATION_WEBAPP_PATH = HARVESTING_LIMESURVEY_QUESTION_LINK_WEBAPP_PATH
			+ "/confirmacion";
	...
	public static HashMap<String, String> getAllWebappPathsAsMap() {
		...
		webAppPathsHashMap.put("HARVESTING_LIMESURVEY_QUESTION_LINK_CONFIRMATION_WEBAPP_PATH",
				HARVESTING_LIMESURVEY_QUESTION_LINK_CONFIRMATION_WEBAPP_PATH);
