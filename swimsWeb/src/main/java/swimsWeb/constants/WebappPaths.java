...
public final class WebappPaths {
	...
	public static HashMap<String, String> getAllWebappPathsAsMap() {
		...
		webAppPatHashMap.put("HARVESTING_OAI_RECORDS_INCLUSION_WEBAPP_PATH",
				HARVESTING_OAI_RECORDS_INCLUSION_WEBAPP_PATH);
		webAppPatHashMap.put("HARVESTING_OAI_RECORDS_INCLUSION_SET_SELECTION_WEBAPP_PATH",
				HARVESTING_OAI_RECORDS_INCLUSION_SET_SELECTION_WEBAPP_PATH);
		webAppPatHashMap.put("HARVESTING_OAI_RECORDS_INCLUSION_DATES_SELECTION_WEBAPP_PATH",
				HARVESTING_OAI_RECORDS_INCLUSION_DATES_SELECTION_WEBAPP_PATH);
		webAppPatHashMap.put("HARVESTING_OAI_RECORDS_INCLUSION_RECORDS_SELECTION_WEBAPP_PATH",
				HARVESTING_OAI_RECORDS_INCLUSION_RECORDS_SELECTION_WEBAPP_PATH);
		webAppPatHashMap.put("HARVESTING_OAI_RECORDS_INCLUSION_CONFIRMATION_WEBAPP_PATH",
				HARVESTING_OAI_RECORDS_INCLUSION_CONFIRMATION_WEBAPP_PATH);
		webAppPatHashMap.put("HARVESTING_OAI_SETS_MANAGEMENT_WEBAPP_PATH", HARVESTING_OAI_SETS_MANAGEMENT_WEBAPP_PATH);
		...
		webAppPatHashMap.put("HARVESTING_THESIS_RECORD_DATA_EXTRACTION_WEBAPP_PATH",
				HARVESTING_THESIS_RECORD_DATA_EXTRACTION_WEBAPP_PATH);
