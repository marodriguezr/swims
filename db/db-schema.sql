...
CREATE TABLE "harvesting"."thesis_assignments" (
  ...
  "thesis_record_id" varchar UNIQUE NOT NULL,
...
CREATE TABLE "harvesting"."thesis_assignment_limesurvey_tokens" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE "harvesting"."thesis_assignments" ADD FOREIGN KEY ("thesis_record_id") REFERENCES "harvesting"."oai_records" ("id");

ALTER TABLE "harvesting"."thesis_assignment_limesurvey_tokens" ADD FOREIGN KEY ("thesis_assignment_id") REFERENCES "harvesting"."thesis_assignments" ("id");
