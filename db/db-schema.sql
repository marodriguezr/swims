...
CREATE TABLE "harvesting"."study_variable_types" (
...
CREATE TABLE "harvesting"."study_variables" (
  ...
  "study_variable_type_id" int NOT NULL
);

CREATE TABLE "harvesting"."limesurvey_survey_question_study_variable_associations" (
  "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "limesurvey_survey_id" int NOT NULL,
  "limesurvey_survey_question_code" varchar UNIQUE NOT NULL,
  "study_variable_id" int UNIQUE NOT NULL
);
...
CREATE TABLE "harvesting"."limesurvey_survey_responses" (
  "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "limesurvey_survey_question_code" varchar NOT NULL,
  "limesurvey_survey_answer_code" varchar NOT NULL,
...
ALTER TABLE "harvesting"."study_variables" ADD FOREIGN KEY ("study_variable_type_id") REFERENCES "harvesting"."study_variable_types" ("id");

ALTER TABLE "harvesting"."limesurvey_survey_question_study_variable_associations" ADD FOREIGN KEY ("study_variable_id") REFERENCES "harvesting"."study_variables" ("id");
...
ALTER TABLE "harvesting"."limesurvey_survey_responses" ADD FOREIGN KEY ("limesurvey_survey_assignment_id") REFERENCES "harvesting"."limesurvey_survey_assignments" ("id");
