...
CREATE TABLE "harvesting"."expected_answers" (
  ...
  "survey_assignment_id" int NOT NULL,
  "created_at" timestamp NOT NULL DEFAULT (now()),
  "updated_at" timestamp NOT NULL DEFAULT (now())
);

CREATE TABLE "harvesting"."uncoded_expected_answers" (
  "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "limesurvey_question_id" int NOT NULL,
...
CREATE TABLE "harvesting"."unexpected_answers" (
  "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "limesurvey_question_id" int NOT NULL,
  "answer" varchar NOT NULL,
  "survey_assignment_id" int NOT NULL,
...
CREATE UNIQUE INDEX ON "harvesting"."questions" ("limesurvey_question_title", "limesurvey_survey_id");
...
ALTER TABLE "harvesting"."expected_answers" ADD FOREIGN KEY ("limesurvey_question_id") REFERENCES "harvesting"."questions" ("limesurvey_question_id");

ALTER TABLE "harvesting"."expected_answers" ADD FOREIGN KEY ("survey_assignment_id") REFERENCES "harvesting"."survey_assignments" ("id");

ALTER TABLE "harvesting"."uncoded_expected_answers" ADD FOREIGN KEY ("limesurvey_question_id") REFERENCES "harvesting"."questions" ("limesurvey_question_id");

ALTER TABLE "harvesting"."uncoded_expected_answers" ADD FOREIGN KEY ("survey_assignment_id") REFERENCES "harvesting"."survey_assignments" ("id");

ALTER TABLE "harvesting"."unexpected_answers" ADD FOREIGN KEY ("limesurvey_question_id") REFERENCES "harvesting"."questions" ("limesurvey_question_id");

ALTER TABLE "harvesting"."unexpected_answers" ADD FOREIGN KEY ("survey_assignment_id") REFERENCES "harvesting"."survey_assignments" ("id");
