...
CREATE TABLE "harvesting"."questions" (
  ...
  "limesurvey_parent_question_title" varchar(20) NOT NULL,
...
ALTER TABLE "harvesting"."responses" ADD FOREIGN KEY ("survey_assignment_id") REFERENCES "harvesting"."survey_assignments" ("id");
