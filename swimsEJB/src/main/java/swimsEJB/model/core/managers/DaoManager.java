...
public class DaoManager {
	...
	public Object findOneById(Class clase, Object pID) throws Exception {
		if (pID == null)
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List findManyWhere(Class clase, String pClausulaWhere, String pOrderBy) {
		Query q;
		List listado;
		String sentenciaJPQL;
	 ...
	 * @throws Exception
	 */
	public Object createOne(Object pObjeto) throws Exception {
		if (pObjeto == null)
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public Object deleteOneById(Class clase, Object pID) throws Exception {
		if (pID == null) {
			throw new Exception("Debe especificar un identificador para eliminar el dato solicitado.");
		}
		Object o = findOneById(clase, pID);
		try {
			em.remove(o);
			return o;
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public Object updateOne(Object pObjeto) throws Exception {
		if (pObjeto == null)
