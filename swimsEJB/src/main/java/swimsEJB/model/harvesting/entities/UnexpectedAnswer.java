...
/**
 * The persistent class for the unexpected_answers database table.
 * 
 */
@Entity
@Table(name="unexpected_answers", schema="harvesting")
@NamedQuery(name="UnexpectedAnswer.findAll", query="SELECT u FROM UnexpectedAnswer u")
public class UnexpectedAnswer implements Serializable {
