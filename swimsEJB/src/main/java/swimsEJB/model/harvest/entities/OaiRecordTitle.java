...
/**
 * The persistent class for the oai_record_titles database table.
 * 
 */
@Entity
@Table(name="oai_record_titles",schema = "harvest")
@NamedQuery(name="OaiRecordTitle.findAll", query="SELECT o FROM OaiRecordTitle o")
public class OaiRecordTitle implements Serializable {
